...
public class hotelProfileRF extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotel_profile_rf);
        //InitialiserLesTextViews
        nomHotel = findViewById(R.id.textView43);
        idHotel = getIntent().getStringExtra("idHotel");
        idUser = getIntent().getStringExtra("idUser");
        reserver = findViewById(R.id.button15_2);
        reserver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //WILLCHANGE
                Intent intent = new Intent(hotelProfileRF.this,rechercherUneChamberSurFavoris.class);
        ...
        ajouterComment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(hotelProfileRF.this,AjouterCommetaire.class);
                intent.putExtra("idHotel", idHotel);
                intent.putExtra("idUser", idUser);
                startActivity(intent);
            }
        ...
        StringRequest stringRequest1 = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if(obj.length() == 0){
                        ...
                        LinearLayoutManager llm = new LinearLayoutManager(hotelProfileRF.this);
                        llm.setOrientation(LinearLayoutManager.HORIZONTAL);
                        MyadapterCommet myadapter = new MyadapterCommet(hotelProfileRF.this, nom, commentaire);
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(hotelProfileRF.this,"Erreur de Connexion, Try Later",Toast.LENGTH_LONG).show();
            }
        }){
            @Nullable
            @Override
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url4, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if(response.equals("Ajouter")){
                    Toast.makeText(hotelProfileRF.this,"Vous avez ajouté  l'hotel "+ nomHotel.getText().toString() +" a votre liste favoris",Toast.LENGTH_LONG).show();
                }
                else if (response.equals("Supprimer")){
                    Toast.makeText(hotelProfileRF.this,"Vous avez enlevé  l'hotel "+ nomHotel.getText().toString() +" a votre liste favoris",Toast.LENGTH_LONG).show();
                }
                else{
                    Toast.makeText(hotelProfileRF.this,"Erreur, essayer plus tard",Toast.LENGTH_LONG).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(hotelProfileRF.this,error.toString(),Toast.LENGTH_LONG).show();
            }
        }){
            @Nullable
            @Override
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url2, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if(response.equals("sucess")){
                    Toast.makeText(hotelProfileRF.this,"Opération faite par succès",Toast.LENGTH_LONG).show();
                }
                else{
                    Toast.makeText(hotelProfileRF.this,"Erreur, Try Later",Toast.LENGTH_LONG).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
